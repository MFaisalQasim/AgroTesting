...
Route::get('/contact-us', 'AgroasiaTractors@contactus')->name('frontend.contact_us.index');
Route::get('/testimonial', 'AgroasiaTractors@testimonial')->name('frontend.testimonial.index');
Route::get('/bank-details', 'AgroasiaTractors@bankdetails')->name('frontend.bank_details.index');
Route::get('/site-map', 'AgroasiaTractors@sitemap')->name('frontend.site_map.index');
Route::get('/how-to-place-order', 'AgroasiaTractors@howtoplaceorder')->name('frontend.how_to_place_order.index');
Route::get('/authorized-sales-agents', 'AgroasiaTractors@salesagent')->name('frontend.sales_agent.index');
Route::get('/faq', 'AgroasiaTractors@faq')->name('frontend.faq.index');
Route::get('/shipment', 'AgroasiaTractors@shipment')->name('frontend.shipment.index');
Route::get('/care-tip', 'AgroasiaTractors@caretip')->name('frontend.care_tip.index');
Route::get('/page-gallery', 'AgroasiaTractors@gallery')->name('frontend.gallery.index');
Route::get('/mearsk-line', 'AgroasiaTractors@maerskline')->name('frontend.mearsk_line.index');
Route::get('/cma-cgm', 'AgroasiaTractors@cmacgm')->name('frontend.cma_cgm.index');
Route::get('/msc-pakistan', 'AgroasiaTractors@mscpakistan')->name('frontend.msc_pakistan.index');
Route::post('/enquiry-form', 'AgroasiaTractors@enquiryform')->name('frontend.includes.enquiryform');
Route::post('/contact-form', 'AgroasiaTractors@contactform')->name('frontend.contactform.index');
