                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                                ...
                                <div class="row">
                                    @foreach ($mf as $item)
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <div class="box">
                                                <img class="d-block w-100 h-100" style="width:100px,height:100px"
                                                    src="{{ asset($item->getfrontTractorImages['images']) }}"
                                                    alt="...">
                                                <h6 class="title-product">{{ $item->name }}
                                                </h6>
                                                <a
                                                    href="{{ route('frontend.product.index', ['brand' => $item->getBrandName['name'], 'slag' => $item->tractor_slug]) }}">
                                                    <button class="btn-details">View Details</button></a>
                                                <button data-whatever="{{ $item->name }}" class="btn-order"
                                                    data-bs-toggle="modal" data-bs-target="#myModal2">Order Now</button>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                <a href="{{ route('frontend.massey_ferguson_tractors.index') }}"><button
                                        class="btn-view">View More</button></a>
                            </div>
                        </section>
                        <section id="section-3">
                            <div class="container">
                                <h1 class="heading">New Holland Tractors <span>(50HP to 85HP)</span>
                                </h1><br>
                                <div class="row">
                                    @foreach ($nh as $item)
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <a href="{{ route('frontend.new_holland_tractors.index') }}"><button class="btn-view">View
                                        More</button></a>
                        ...
                        <section id="section-4">
                            <div class="container">
                                <h1 class="heading">Brand New Agricultural Farm Implements
                                </h1><br>
                                <div class="row">
                                    @foreach ($imp as $item)
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <a href="{{ route('frontend.farm_implements.index') }}"><button class="btn-view">View
                                        More</button></a>
                            </div>
                        </section>
