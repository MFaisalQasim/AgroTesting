...
<div class="form-group {{ $errors->has('tractor_slug') ? 'has-error' : ''}}">
    ...
    <select name="tractor_slug" id="tractor_slug" class=" select2 form-control">
        <option value="{{ $faq->tractor_slug }}" >{{ $faq->tractor_slug }}</option>
...
<div class="form-group {{ $errors->has('question') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="question" type="text" id="question" value="{{ $faq->question}}" required>
...
<div class="form-group {{ $errors->has('answer') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="answer" type="text" id="answer" value="{{ $faq->answer}}">
